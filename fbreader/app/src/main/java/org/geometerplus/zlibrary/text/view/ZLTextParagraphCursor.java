...
public final class ZLTextParagraphCursor {
	private static final class Processor {
		...
		private Processor(ZLTextParagraph paragraph, String language, ExtensionElementManager extManager, LineBreaker lineBreaker, List<ZLTextMark> marks, int paragraphIndex, ArrayList<ZLTextElement> elements) {
